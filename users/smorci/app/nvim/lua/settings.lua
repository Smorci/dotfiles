...
let g:nixpkgs_fmt_toggle = 1

if &filetype == 'nix' && nixpkgs_fmt_toggle == 1
  autocmd BufWritePost * system('nixpkgs-fmt ' . expand('%'))
endif
]]
...
function! NixpkgsFmtToggle()
  call NegateVariable(nixpkgs_fmt_toggle)
endfunction

function! NegateVariable(var)
  let a:var = !a:var
  return a:var
endfunction
